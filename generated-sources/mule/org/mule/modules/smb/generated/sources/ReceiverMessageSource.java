...
package org.mule.modules.smb.generated.sources;
...
/**
 * ReceiverMessageSource wraps {@link org.mule.modules.smb.SmbConnector#receiver(java.lang.String, org.mule.api.callback.SourceCallback)} method in {@link SmbConnector } as a message source capable of generating Mule events.  The POJO's method is invoked in its own thread.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-07-19T03:22:28+01:00", comments = "Build UNNAMED.2793.f49b6c7")
public class ReceiverMessageSource
    ...
    implements Runnable, FlowConstructAware, MuleContextAware, Startable, Stoppable, MessageSource
{
    ...
    public ReceiverMessageSource(String operationName) {
        super(operationName);
    }
    ...
    public void run() {
        ...
        try {
            ...
            final String transformedFilePattern = ((String) transform(getMuleContext(), ((MuleEvent) null), getClass().getDeclaredField("_filePatternType").getGenericType(), null, filePattern));
            while (!Thread.currentThread().isInterrupted()) {
                processTemplate.execute(new ProcessCallback<Object,Object>() {
                    ...
                    public Object process(Object object)
                        throws Exception
                    {
                        ((SmbConnector) object).receiver(transformedFilePattern, sourceCallback);
                        return null;
                    }
