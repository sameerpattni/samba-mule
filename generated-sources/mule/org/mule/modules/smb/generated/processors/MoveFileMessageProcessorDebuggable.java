...
public class MoveFileMessageProcessorDebuggable
    extends MoveFileMessageProcessor
    implements DebugInfoProvider
{


    public MoveFileMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("smbObject", "Smb object", (jcifs.smb.SmbFile.class), smbObject, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("smbOriginalFilename", "Smb original filename", (java.lang.String.class), smbOriginalFilename, muleEvent));
