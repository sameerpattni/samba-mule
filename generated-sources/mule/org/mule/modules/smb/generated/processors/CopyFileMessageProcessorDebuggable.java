...
public class CopyFileMessageProcessorDebuggable
    extends CopyFileMessageProcessor
    implements DebugInfoProvider
{


    public CopyFileMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("printerFileExtensionType", "Printer file extension type", (java.lang.String.class), printerFileExtensionType, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("fileName", "File name", (java.lang.String.class), fileName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("payload", "Payload", (java.lang.String.class), payload, muleEvent));
