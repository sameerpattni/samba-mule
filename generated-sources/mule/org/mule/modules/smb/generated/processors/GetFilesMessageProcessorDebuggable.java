...
public class GetFilesMessageProcessorDebuggable
    extends GetFilesMessageProcessor
    implements DebugInfoProvider
{


    public GetFilesMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("filePattern", "File pattern", (java.lang.String.class), filePattern, muleEvent));
